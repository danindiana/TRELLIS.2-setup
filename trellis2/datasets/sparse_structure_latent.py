...
class SparseStructureLatentVisMixin:
    def __init__(
        self,
        *args,
        pretrained_ss_dec: str = 'microsoft/TRELLIS.2-4B/ckpts/ss_dec_conv3d_16l8_fp16.json',
...
class SparseStructureLatent(SparseStructureLatentVisMixin, StandardDatasetBase):
    ...
    def __init__(self,
        ...
        *,
        ...
        pretrained_ss_dec: str = 'microsoft/TRELLIS.2-4B/ckpts/ss_dec_conv3d_16l8_fp16',
        ss_dec_path: Optional[str] = None,
        ss_dec_ckpt: Optional[str] = None,
    ):
